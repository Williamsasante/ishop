				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						...
						@foreach($multiImag as $img)
							<div class="product-preview">
								<img src="{{ asset($img->photo_name ) }} " data-echo="{{ asset($img->photo_name ) }} " alt="">
							</div>
							@endforeach
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="product-details">
                            ...
                            @else
                                <h3  class="product-price">GH₵{{ number_format($product->discount_price) }} <del class="product-old-price">GH₵{{ number_format($product->selling_price) }}</del></h3>
								@endif
